...
export function SettingsPage({ role }: { role: "admin" | "superadmin" }) {
  ...
  return (
    <div className="mt-3 sm:mt-4">
      <Section title="User Management">
        ...
        <div className="border-t border-[rgba(0,0,0,0.06)] dark:border-[rgba(255,255,255,0.06)] pt-4 mt-2">
          <div className="text-xs font-semibold uppercase tracking-widest text-gray-400 dark:text-gray-500 mb-3">Create New User</div>
          {createError && (
