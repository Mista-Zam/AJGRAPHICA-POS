...
export function getPickupColor(isoDate: string) {
  ...
  if (diff < 0) return "text-[#DC2626] dark:text-[#e87070] font-semibold";
  if (diff === 0) return "text-[#0F6E56] dark:text-[#5abb9e] font-semibold";
  return "text-gray-600 dark:text-gray-400";
}

export const STATUS_COLORS: Record<string, string> = {
  Urgent: "bg-[#DC2626] dark:bg-[#DC2626] text-white dark:text-white border border-[#DC2626] dark:border-[#DC2626]",
...
export const PAYMENT_COLORS: Record<string, string> = {
  Unpaid: "bg-[#DC2626] dark:bg-[#DC2626] text-white dark:text-white border border-[#DC2626] dark:border-[#DC2626]",
